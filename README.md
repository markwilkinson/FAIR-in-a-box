...
To use FAIR-in-a-box you also need to download the *standalone* graphDB triple store free edition. Follow the steps below to get free edition of graphdb.
...
```sh
mv graphdb-free-{version}-dist.zip FAIR-in-a-box/bootstrap/graph-db
```
