...
3.  Uncomment the "hitch" ~~and "varnish"~~ services in the docker-compose file.  **UPDATED: Varnish has a frustrating habit of caching... I no longer recommend that you use it for this application.   MDW**
